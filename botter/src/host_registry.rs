...
impl HostRegistry {
    ...
    pub fn load_or_create() -> Result<Self, String> {
        ...
        let agent_host = Self::generate_random_host();
    ...
    /// Get the agent host name with "com.chromium." prefix
    pub fn agent_host_name(&self) -> String {
        format!("com.chromium.{}", self.agent_host)
    }
}
...
mod tests {
    ...
    fn test_host_name_format() {
        let registry = HostRegistry {
            agent_host: "abcd1234".to_string(),
        };
        assert_eq!(registry.agent_host_name(), "com.chromium.abcd1234");
    }
}
